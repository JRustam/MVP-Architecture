...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        jsonPlaceHolderApi = retrofit.create(IJsonPlaceHolderApi.class);
    ...
    private void getPosts() {
        ...
        parametres.put("userId", "1");
        parametres.put("_sort", "id");
        parametres.put("_order", "desc");

        Call<List<Post>> call = jsonPlaceHolderApi.getPosts(parametres);
    ...
    private void deletePost() {
        Call<Void> call = jsonPlaceHolderApi.deletePosts(10);
